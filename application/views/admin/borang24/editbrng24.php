                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang24/updatebrng24" method="post">
                                <input type="hidden" value="<?php echo $id_brng24; ?>" name="id_brng24">
