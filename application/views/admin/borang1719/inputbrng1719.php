...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang1719/simpanbrng1719" method="post">
                                <input type="hidden" name="id_brng1719">
    ...
    $sql = mysql_query("SELECT * FROM tbl_mhs ORDER BY id_mhs ASC");
    ...
    ?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text"class="form-control datepicker-input" name="tgl_lulus" placeholder="yyyy-mm-dd">
                                  </div>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lama_ta">
                                  </div>
