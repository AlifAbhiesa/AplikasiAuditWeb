                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>kegiatan/updatekegiatan" method="post">
                                <input type="hidden" value="<?php echo $id_kegiatan; ?>" name="id_kegiatan">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text"class="form-control" value="<?php echo $nama_kegiatan; ?>" name="nama_kegiatan">
                                  </div>
