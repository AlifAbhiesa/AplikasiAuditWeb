...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang2223/simpanbrng2223" method="post">
                                <input type="hidden" name="id_brng2223">
    ...
    ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text"class="form-control" name="sedia_gbpp">
                                  </div>

                                  
                                  <div class="form-group">
                                    <label>Ketersediaan RKPSS</label>
                                    <input type="text" class="form-control" name="sedia_rkpss">
                                  </div>
