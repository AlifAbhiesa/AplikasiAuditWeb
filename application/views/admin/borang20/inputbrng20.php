...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang20/simpanbrng20" method="post">
                                <input type="hidden" name="id_brng20">
    ...
    ?>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ipk_kelas">
                                  </div>
								   
								  <div class="form-group">
                                    <label>IPK Matakuliah</label>
                                    <input type="text" class="form-control" name="ipk_mtk">
                                  </div>
