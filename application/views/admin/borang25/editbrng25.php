...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang25/updatebrng25" method="post">
                                <input type="hidden" value="<?php echo $id_brng25; ?>" name="id_brng25">
    ...
    ?>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $reg_akhir; ?>" name="reg_akhir">
                                  </div>
                                  
								  <div class="form-group">
                                    <label>Batas Studi</label>
                                    <input type="text" class="form-control" value="<?php echo $bts_studi; ?>" name="bts_studi">
                                  </div>
    ...
    ?>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $stts_keluar; ?>" name="stts_keluar">
                                  </div>
								  
								   <div class="form-group">
                                    <label>Mundur Semester Pertama</label>
                                    <input type="text" class="form-control" value="<?php echo $mundur_pertama; ?>" name="mundur_pertama">
                                  </div>
								    <div class="form-group">
