...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang2629/simpanbrng2629" method="post">
                                <input type="hidden" name="id_brng2629">
    ...
    ?>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker-input" name="bln_thn">
                                  </div>
								  ...
								  <div class="form-group">
                                    <label>Hibah Penelitian</label>
                                    <input type="text" class="form-control" name="hibah_penelitian">
                                  </div>
                                  
								  <div class="form-group">
                                    <label>Dana Pribadi (Rp.)</label>
                                    <input type="text" class="form-control" name="dana_pribadi">
                                  </div>
								  
								   <div class="form-group">
                                    <label>Dana Lokal/Nasional (Rp.)</label>
                                    <input type="text" class="form-control" name="dana_lokal">
                                  </div>
								  
								   <div class="form-group">
                                    <label>Dana Internasional (Rp.)</label>
                                    <input type="text" class="form-control" name="dana_internasional">
                                  </div>
