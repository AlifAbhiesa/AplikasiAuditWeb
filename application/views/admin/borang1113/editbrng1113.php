                    ...
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <input type="hidden" name="id_brng1113" value="<?php echo $id_brng1113; ?>">
                                  <div class="form-group">
                                    <label>Nama Matakuliah</label>
                                    <input type="text" disabled ="true" class="form-control" value="<?php echo mysql_result($q,1); ?>">
                                  </div>
                                  <div class="form-group">
                                    <label>Kelas</label>
                                    <input type="text" value="<?php echo $kelas; ?>" class="form-control" name="kelas">
                                  </div>

                                  
                                  <div class="form-group">
                                    <label>Kehadiwan Dosen</label>
                                    <input type="text" class="form-control" value="<?php echo $hdr_dsn; ?>" name="hdr_dsn">
                                  </div>
								  
                                  <div class="form-group">
                                    <label>Kehadiran Kuliah Mahasiswa</label>
                                    <input type="text" class="form-control" value="<?php echo $hdr_mhsw; ?>" name="hdr_mhsw">
                                  </div>
                                   <div class="form-group">
