...
<body class="fixed">
            ...
            <div class="rightside">
                <div class="page-head">
                    <h1>Isi Data Borang 11 dan 13</h1>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang1113/simpanbrng1113" method="post">
                                <input type="hidden" name="id_brng1113">
    ...
    ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="hdr_dsn">
                                  </div>
								  
								   <div class="form-group">
                                    <label>Kehadiran Kuliah Mahasiswa</label>
                                    <input type="text" class="form-control" name="hdr_mhsw">
                                  </div>
