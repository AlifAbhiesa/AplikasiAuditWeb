...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang3132/updatebrng3132" method="post">
                                <input type="hidden" value="<?php echo $id_brng3132; ?>" name="id_brng3132">
								
	  
								  <div class="form-group">
                                    <label>Judul Kegiatan Pelayanan/Pengabdian kepada Masyarakat</label>
                                    <input type="text" class="form-control" value="<?php echo $judul_kegiatan; ?>" name="judul_kegiatan">
                                  </div>
    ...
    ?>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $tempat; ?>" name="tempat">
                                  </div>
								  
								  <div class="form-group">
                                    <label>Waktu Pelaksanaan</label>
                                    <input type="text" class="form-control datepicker-input" value="<?php echo $waktu; ?>" name="waktu">
                                  </div>
								  
								  
								   <div class="form-group">
                                    <label>Jumlah Dana Yang Terhimpun</label>
                                    <input type="text" class="form-control" value="<?php echo $jml_dana; ?>" name="jml_dana">
                                  </div>
								  
								  <div class="form-group">
                                    <label>Hibah Pengabdian kepada Masyarakat</label>
                                    <input type="text" class="form-control" value="<?php echo $hibah_pengabdian; ?>" name="hibah_pengabdian">
                                  </div>
