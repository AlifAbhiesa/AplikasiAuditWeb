...
<?php 
$q = mysql_query("select nama_dsn from tbl_dsn,tbl_brng15 where tbl_dsn.id_dsn = $id_dsn");
$result = $q;
?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang15/updatebrng15" method="post">
                                <input type="hidden" name="id_brng15" value="<?php echo $id_brng15; ?>">
                                  ...
                                  <div class="form-group">
                                    <label>Hasil Kuesioner Mahasiswa</label>
                                    <input type="text" class="form-control" value="<?php echo $hasil_kuesioner; ?>" name="hasil_kuesioner">
                                  </div>
