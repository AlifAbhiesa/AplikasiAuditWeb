                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>indikator/updateindikator" method="post">
                               
								  
								  <div class="form-group">
                                    <label>Kode Indikator</label>
                                    <input type="text" class="form-control" value="<?php echo $kode_indikator; ?>" name="kode_indikator">
                                  </div>
                                  
								  <div class="form-group">
                                    <label>Indikator Audit</label>
                                    <textarea type="text" class="form-control" name="indikator_audit"><?php echo $indikator_audit; ?></textarea>
                                  </div>
