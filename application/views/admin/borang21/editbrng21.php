...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang21/updatebrng21" method="post">
                                <input type="hidden" value="<?php echo $id_brng21; ?>" name="id_brng21">
    ...
    ?>
                                  ...
                                  <div class="form-group">
                                    <label>SKS Smester</label>
                                    <input type="text"class="form-control" value="<?php echo $sks_smester; ?>" name="sks_smester">
                                  </div>
								  
								   <div class="form-group">
                                    <label>IPS</label>
                                    <input type="text"class="form-control" value="<?php echo $ips; ?>" name="ips">
                                  </div>
								  ...
								  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $sks_total; ?>" name="sks_total">
                                  </div>
