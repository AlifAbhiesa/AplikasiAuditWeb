...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang21/simpanbrng21" method="post">
                                <input type="hidden" name="id_brng21">
    ...
    ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text"class="form-control" name="sks_smester">
                                  </div>
