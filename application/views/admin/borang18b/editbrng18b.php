...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang18b/updatebrng18b" method="post">
                                <input type="hidden" value="<?php echo $id_brng18b; ?>" name="id_brng18b">
    ...
    ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text"class="form-control" value="<?php echo $stts_kuliah; ?>" name="stts_kuliah">
                                  </div>
