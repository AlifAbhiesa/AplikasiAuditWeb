                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang34/updatebrng34" method="post">
                                <input type="hidden" value="<?php echo $id_brng34; ?>" name="id_brng34">
								
								<div class="form-group">
                                    <label>Karya</label>
                                    <input type="text" class="form-control" value="<?php echo $karya; ?>" name="karya">
                                  </div>
								  
                                  
								   <div class="form-group">
                                    <label>Waktu Mendaftarkan Surat ke HaKI</label>
                                    <input type="text" class="form-control datepicker-input" value="<?php echo $waktu_daftar; ?>" name="waktu_daftar">
                                  </div>
								  
								  <div class="form-group">
                                    <label>Waktu Mendapatkan Surat dari HaKI</label>
                                    <input type="text" class="form-control datepicker-input" value="<?php echo $waktu_dapat; ?>" name="waktu_dapat">
                                  </div>
