...
<body class="fixed">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>borang35/updatebrng35" method="post">
                                <input type="hidden" value="<?php echo $id_brng35; ?>" name="id_brng35">
								
                                  <div class="form-group">
                                    <label>NIK Dosen</label>
                                     <select class="form-control" name="id_dsn">
    <option value="<?php echo $id_dsn; ?>">---- NIK DOSEN ----</option>
    <?php
    ...
    ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text"class="form-control" value="<?php echo $nama_org; ?>" name="nama_org">
                                  </div>

                                  
                                  <div class="form-group">
                                    <label>Kurun Waktu</label>
                                    <input type="text" class="form-control" value="<?php echo $kurun_wkt; ?>" name="kurun_wkt">
                                  </div>
