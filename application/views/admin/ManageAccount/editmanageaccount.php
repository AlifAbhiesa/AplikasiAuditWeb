                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>manageaccount/updatemanageaccount" method="post">
                                <input type="hidden" value="<?php echo $id_user; ?>" name="id_user">
								
								<div class="form-group">
                                    <label>Username</label>
                                    <input name="nama_user" type="text" class="form-control" value="<?php echo $nama_user ?>">
                                  </div>
								  
								 <div class="form-group">
                                    <label>Password</label>
                                    <input name="pass_user" type="text" class="form-control" value="<?php echo $pass_user ?>">
                                  </div>
